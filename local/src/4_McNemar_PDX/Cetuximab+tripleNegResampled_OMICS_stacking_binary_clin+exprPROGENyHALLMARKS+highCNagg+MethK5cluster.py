...
# load augmented (SMOTENC oversample) training data
X_train = pd.read_csv(snakemake.input.X_train_resampled,
     sep="\t", header=0, index_col=0) 
y_train  = pd.read_csv(snakemake.input.Y_train_resampled,
     sep="\t", header=0, index_col=0)
y_train[target_col] = y_train[target_col].replace(Y_class_dict)
...
hyperparameter_grid = {
          ...
          #'pipeline-2__': [],
          # Mut params
          'pipeline-3__chi2filterFscore__k': [50, 'all'],
          ...
          'pipeline-4__chi2filterFscore__k': [12, 'all'],
          ...
          'pipeline-5__chi2filterFscore__k': [25, 'all'],
